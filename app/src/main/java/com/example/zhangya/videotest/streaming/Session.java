...
package com.example.zhangya.videotest.streaming;
...
import com.example.zhangya.videotest.streaming.audio.AudioStream;
import com.example.zhangya.videotest.streaming.exceptions.CameraInUseException;
import com.example.zhangya.videotest.streaming.exceptions.ConfNotSupportedException;
import com.example.zhangya.videotest.streaming.exceptions.InvalidSurfaceException;
import com.example.zhangya.videotest.streaming.exceptions.StorageUnavailableException;
import com.example.zhangya.videotest.streaming.gl.SurfaceView;
import com.example.zhangya.videotest.streaming.rtsp.RtspClient;
import com.example.zhangya.videotest.streaming.video.VideoQuality;
import com.example.zhangya.videotest.streaming.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.zhangya.videotest.streaming.Session");
		thread.start();
