...
import com.example.zhangya.videotest.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.example.zhangya.videotest.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.example.zhangya.videotest.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link com.example.zhangya.videotest.streaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "com.example.zhangya.videotest.streaming-";
